...
class AppHeader extends ConsumerWidget implements PreferredSizeWidget {
  ...
  // app_header2.dart 파일의 build 메서드
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AppBar(
      backgroundColor: isScrolled
          ? const Color(0xFFFE8B21).withOpacity(1.0)
          : const Color(0xFFFE8B21).withOpacity(0.6),
          ...
          child: Row(
            ...
            children: [
              InkWell(
                  ...
                  child: Image.asset('logo/logo-white.png', height: isDesktop ? 24 : 16)),
              if (isDesktop)
              Expanded(
                child: Row(
                  children: [
  ...
  Widget _navButton(BuildContext context, String text, String routeName,
